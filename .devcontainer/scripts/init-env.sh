...
ALL_MANAGED_VARS=(TS_AUTHKEY GH_TOKEN FOREMAN_AGENT_GH_TOKEN CLAUDE_CODE_OAUTH_TOKEN FOREMAN_DEEPSEEK_API_KEY FOREMAN_KIMI_API_KEY FOREMAN_GLM_API_KEY FOREMAN_OPENAI_API_KEY AGENT_DECK_TELEGRAM_KEY ANTHROPIC_API_KEY)
