...
Term → one-line definition for the cross-cutting vocabulary of Foreman.
...
| `ponderousdev-ci` (GitHub App) | The CI automation app that mints short-lived tokens for CI workflows (not a PAT). See [architecture/security.md](architecture/security.md). |
