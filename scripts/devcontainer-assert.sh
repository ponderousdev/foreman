...
assert_unit() {
    ...
    local bot_allow=(GH_TOKEN CLAUDE_CODE_OAUTH_TOKEN FOREMAN_DEEPSEEK_API_KEY FOREMAN_KIMI_API_KEY AGENT_DECK_TELEGRAM_KEY)
    ...
    : >"$env_file"
    TS_AUTHKEY=fake GH_TOKEN=fake FOREMAN_DEEPSEEK_API_KEY=fake FOREMAN_KIMI_API_KEY=fake \
