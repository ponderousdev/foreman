...
ALL_MANAGED_VARS=(TS_AUTHKEY GH_TOKEN FOREMAN_AGENT_GH_TOKEN CLAUDE_CODE_OAUTH_TOKEN FOREMAN_DEEPSEEK_API_KEY AGENT_DECK_TELEGRAM_KEY ANTHROPIC_API_KEY)
