...
- [roadmap.md](roadmap.md) — where it's going (now / next / later); a pointer to
  live planning (issue tracker / project board), not a copy of it.
- [domain.md](domain.md) — the conceptual model: concepts, relationships,
